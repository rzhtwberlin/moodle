...
/**
 * Admin setting field to select multiple items from list with autocomplete.
 */
...
/**
 * Admin setting field to select multiple course categories from list with autocomplete.
 */
class admin_settings_coursecat_multiselect extends admin_setting_configmultiselect_autocomplete {
    /**
     * Calls parent::__construct with specific arguments
     *
     * @param string $name unqique name of the setting
     * @param string $visiblename localised
     * @param string $description long localised info
     * @param array $defaultsetting array of selected category ids
     */
    public function __construct($name, $visiblename, $description, $defaultsetting = []) {
        parent::__construct($name, $visiblename, $description, $defaultsetting, null);
    }
