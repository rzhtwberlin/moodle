...
$string['backup_courses_in_categories'] = 'Backup courses only in this categories';
$string['backup_courses_in_categories_help'] = 'Select the course categories whose courses should be backed up. All other courses will not be backed up.';
